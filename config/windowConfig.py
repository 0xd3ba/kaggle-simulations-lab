...
DEF_ENV_INFO     = [
    ...
    "<b>Choose your environment and algorithm, configure the neural network and start training</b> - As simple as that 😎",
...
GUI_WDW_MIN_HEIGHT = 700
GUI_WDW_MAX_WIDTH  = 540
GUI_WDW_MAX_HEIGHT = 700
